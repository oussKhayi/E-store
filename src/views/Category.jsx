          ...
          <div className="card p-1">
            <div className="d-flex justify-content-between align-items-center p-2">
              ...
              <div>
                {" "}
                <img
                  src="https://thefoschini.vtexassets.com/arquivos/ids/42772959-800-800?v=638142823169530000&width=800&height=800&aspect=true"
                  height={100}
                  width={100}
                />{" "}
              </div>
          ...
          <div className="card p-2">
            <div className="d-flex justify-content-between align-items-center p-2">
              ...
              <div>
                {" "}
                <img
                  src="https://thefoschini.vtexassets.com/arquivos/ids/42103565-800-800?v=638141535753930000&width=800&height=800&aspect=true"
                  height={100}
                  width={100}
                />{" "}
              </div>
        ...
        <div className="col-md-3">
          <div className="card p-2">
            <div className="d-flex justify-content-between align-items-center p-2">
              <div className="flex-column lh-1 imagename">
                {" "}
                <span>Air</span> <span>Tags</span>{" "}
              </div>
              <div>
                {" "}
                <img
                  src="https://thefoschini.vtexassets.com/arquivos/ids/43893853-800-800?v=638145571122370000&width=800&height=800&aspect=true"
                  height={100}
                  width={100}
                />{" "}
              </div>
          ...
          <div className="card p-2">
            <div className="d-flex justify-content-between align-items-center p-2">
              ...
              <div>
                {" "}
                <img
                  src="https://thefoschini.vtexassets.com/arquivos/ids/42291670-800-800?v=638141772989200000&width=800&height=800&aspect=true"
                  height={100}
                  width={100}
                />{" "}
              </div>
          ...
          <div className="card p-2">
            <div className="d-flex justify-content-between align-items-center p-2">
              ...
              <div>
                {" "}
                <img
                  src="https://thefoschini.vtexassets.com/arquivos/ids/42043584-800-800?v=638141463306770000&width=800&height=800&aspect=true"
                  height={100}
                  width={100}
                />{" "}
              </div>
